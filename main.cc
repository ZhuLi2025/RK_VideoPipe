...
{
    // if(argc!=4){
    //     cout<<"usage: ./program_name [video_path] [config_path] [rtmp|fake|file|screen|rtsp|udp]"<<std::endl;
    //     return 0;
    // }
    ...
    //     des_0->attach_to({msg_broker});
    // }
    // else if(strcmp(argv[3], "rtsp") == 0){
    //     auto des_0 = std::make_shared<vp_nodes::vp_rtsp_des_node>("rtsp_des_0", 0,"192.168.1.99", 8000, "rtsp_0");
    //     des_0->attach_to({msg_broker});
    // }
    // else if(strcmp(argv[3], "udp") == 0){
    //     auto des_0 = std::make_shared<vp_nodes::vp_udp_des_node>("udp_des_0", 0,"192.168.1.100", 8000);
    //     des_0->attach_to({msg_broker});
    // }
    // else{
    //     return 0;
    ...
    // auto des_0 = std::make_shared<vp_nodes::vp_udp_des_node>("udp_des_0", 0,"192.168.1.100", 8000);
    // des_0->attach_to({msg_broker});
    // auto des_1 = std::make_shared<vp_nodes::vp_udp_des_node>("udp_des_1", 0,"192.168.1.101", 8000);
